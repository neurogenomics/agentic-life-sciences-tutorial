...
- The [**PubMed MCP**](https://modelcontextprotocol.io/) and [**Anthropic's life-sciences skills**](https://www.anthropic.com/research/claude-for-life-sciences) can pull the paper's methods for extra context.
