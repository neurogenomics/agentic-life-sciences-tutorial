...
<svg viewBox="0 0 640 400" xmlns="http://www.w3.org/2000/svg" style="max-width:100%;height:auto;font-family:system-ui,sans-serif">
  ...
  <!-- chart area: x=65..495, y=45..325 (430×280) -->
  <!-- y gridlines -->
  ...
  <!-- y-axis labels ($0, $0.25, $0.50, $0.75, $1.00) -->
  ...
  <!--
    All lines start at (65, 325) = origin (0 tokens, $0)
    End at x=495 (200k tokens)
    Scale: X = 65 + tokens*0.00215,  Y = 325 - cost_dollars*280
    cost_dollars at 200k = price_per_mtoken * 0.2
    GPT-4o mini  $0.15 → end y = 325 - 0.03*280 = 316.6
    Kimi K2.5    $0.60 → end y = 325 - 0.12*280 = 291.4
    Haiku 4.5    $1.00 → end y = 325 - 0.20*280 = 269
    Gemini 1.5P  $1.25 → end y = 325 - 0.25*280 = 255
    GPT-4o       $2.50 → end y = 325 - 0.50*280 = 185
    Sonnet 4.6   $3.00 → end y = 325 - 0.60*280 = 157
    Opus 4.6     $5.00 → end y = 325 - 1.00*280 = 45
  -->
  <!-- GPT-4o mini -->
  <line x1="65" y1="325" x2="495" y2="317" stroke="#9CA3AF" stroke-width="1.5"/>
  <!-- Kimi K2.5 — highlighted (used in this course) -->
  ...
  <text x="65" y="378" font-size="9" fill="#6B7280">Shaded band = 150k token danger zone. All costs are input tokens only (output tokens billed separately).</text>
</svg>
...
Kimi K2.5 — the model used in this course via OpenRouter — sits near the bottom of the cost curve at **$0.60/MTok input**, making a 150k-token session cost just **$0.09 per message** compared to $0.45 on Sonnet 4.6. This is why context management still matters even on cheaper models: 50 messages at 150k tokens on Kimi costs **$4.50**, versus **$22.50** on Sonnet and **$37.50** on Opus.
